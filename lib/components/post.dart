...
import 'package:socialmedia/components/interactions/interactions.dart';
import 'package:socialmedia/components/miniprofile.dart';
import 'package:socialmedia/components/shared_post.dart';
...
class Post extends StatelessWidget {
  ...
  int shareCount;
   ...
   Post({super.key, required this.post, this.shareCount = 0});
